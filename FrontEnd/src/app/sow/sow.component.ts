...
export class SOWComponent implements OnInit {
  ...
  constructor(
    ...
    private tpmService: UsttpmserviceService,
    private pocService: UstpocserviceService,
    private recruiterService: RecruiterserviceService,
    private dellManagerService: DellmanagerserviceService,
    ...
    this.service.GetAllSowData().subscribe(
      (res) => {
        ...
        this.totalPages = Math.ceil(
          this.SowList.length / this.pageSizeSelected
        );
  ...
  onEdit() {
    ...
    let obj = {
      ...
      internalResource:
        formValue.internalResource == null ? "" : formValue.internalResource,
      externalResource:
        formValue.externalResource == null ? "" : formValue.externalResource,
      type: "update",
    };
    this.service.UpdateSowData(this.Id, obj).subscribe(
      (res) => {
  ...
  editDetails(data: any) {
    ...
    this.Id = data.sowId;
    this.router.navigate(["/soList"], {
      queryParams: { editMode: this.editmode, myArray: this.Id },
    });
